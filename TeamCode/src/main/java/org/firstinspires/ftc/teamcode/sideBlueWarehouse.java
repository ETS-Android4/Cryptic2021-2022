...
@Autonomous(name="sideBlueWarehouse")

public class sideBlueWarehouse extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        encoderDrive(DRIVE_SPEED,  -82,  -83, 1);  // S1: Forward 47 Inches with 5 Sec timeout
        encoderDrive(TURN_SPEED,   -15, 15, 1);  // S2: Turn Right 12 Inches with 4 Sec timeout
        robot.intakeServo.setPosition(.35);
        sleep(750);
        ...
        encoderDrive(TURN_SPEED,   47, -47, 1);  // S2: Turn Right 12 Inches with 4 Sec timeout

        robot.intakeMotor.setPower(-0.9875642076484353);

        encoderDrive(DRIVE_SPEED, -145, -145, 1);  // S3: Reverse 24 Inches with 4 Sec timeout
