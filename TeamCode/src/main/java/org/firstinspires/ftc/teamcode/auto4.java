...
@Autonomous(name="caaaaaaaaaa")

public class
auto4 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        encoderDrive(DRIVE_SPEED,  -70,  -70, 1);  // S1: Forward 47 Inches with 5 Sec timeout
        ...
        encoderDrive(TURN_SPEED,   60, -60, 1);  // S2: Turn Right 12 Inches with 4 Sec timeout

        encoderDrive(DRIVE_SPEED, -145, -145, 4.0);  // S3: Reverse 24 Inches with 4 Sec timeout
        encoderDrive(TURN_SPEED,   28.5, -28.5, 1);  // S2: Turn Right 12 Inches with 4 Sec timeout
